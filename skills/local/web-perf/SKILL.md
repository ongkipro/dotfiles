---
name: web-perf
description: Analyzes web performance using Chrome DevTools MCP. Measures Core Web Vitals (LCP, INP, CLS) and supplementary metrics (FCP, TBT, Speed Index), identifies render-blocking resources, network dependency chains, layout shifts, caching issues, and accessibility gaps. Use when asked to audit, profile, debug, or optimize page load performance, Lighthouse scores, or site speed. Also triggers on Indonesian phrasing such as "kenapa web-ku lambat", "cek kecepatan situs", "situs lemot", and "audit performa". Biases towards retrieval from current documentation over pre-trained knowledge.
---
