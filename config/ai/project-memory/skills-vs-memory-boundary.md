...
Operational status, accepted requirements, technical decisions, architecture,
tasks, and build evidence belong in the project repository. Project-memory may
point to those files or retain explicitly historical context, but it is never authoritative.
