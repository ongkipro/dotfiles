...
**Locations & IDs:**
- New theme code: `/home/fantastico/Projects/petcue-theme` (own git repo, Dawn base + commits)
...
- Remote theme: **PetCue (Dawn build)** #184212979823 (unpublished). Push with: `shopify theme push --path /home/fantastico/Projects/petcue-theme --store 2mpt3p-xv.myshopify.com --theme 184212979823`
...
**Phases (5):** 1. Foundation/rebrand ✅ · 2. Homepage ✅ · 3. PDP funnel ⏭️ · 4. Cart CRO (upsell, free-ship bar) ⏭️ · 5. Merchandising + social proof + polish ⏭️. Paused by user 2026-06-24 ("skip dulu development"). CRO feature scope still unconfirmed (user answered ambiguously twice).
