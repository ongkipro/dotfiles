...
- KIHeute: German AI productivity content brand for office workers and small business owners; practical AI for office/business, not AI news/art/crypto/programming/gaming/student content.
- Affiliate Germany: Digistore24, Impact, CJ, Awin, PartnerStack, Amazon DE; content channels include YouTube faceless, Pinterest, Medium, Facebook, TikTok.
- Shopify/headless projects: Astro + Tailwind public frontend; Next.js + shadcn/ui for admin/client dashboards when needed.

## Personality / self-analysis notes
- User is interested in Human Design, STIFIn, numerology, and personality analysis.
- Human Design result is not yet confirmed as a single reliable fact in memory; do not treat conflicting prior labels as final without verification.
- Family/children biodata should not be stored in GitHub memory unless the user explicitly confirms exact details to store.

## Decision preferences
- Prefer Linux/Ubuntu and terminal-first workflow over GUI-heavy setup.
- Prefer no-sudo for dev tools: mise/npm/pipx; sudo only for true system packages.
- Prefer scalable, reusable systems over one-off manual work.
- Prefer practical execution roadmap over abstract theory.
- Always consider profit, operational cost, speed, compliance risk, maintenance burden, and scalability before recommending a path.
