...
**How to apply:** new deploys/backups shouldn't copy uploads. If `/data` fills too, revisit object storage (R2) or retention limits. Disk checks: `df -h / /data`. See [[reference_deploy]].
