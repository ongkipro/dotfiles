...
- `Rollback-Command` is a repository-local command or runbook command. Do not put secrets here.
- `Backup-Proof` is `NOT_REQUIRED` unless migration risk requires a verified backup reference/evidence.
