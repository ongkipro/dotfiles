# Archived task contracts — test efficacy and CI portability

Moved out of `TASKS.md` on 2026-09-10 to stay inside the hot-context budget.
Every entry has ledger evidence ending in PASS. The thread through them: a guard
that does not guard, found by breaking something rather than by reading it.
...
- **TASK-064 / REQ-MODEL-AGNOSTIC (R3).** Owner-authorized removal of model/provider
  ...
  not rewritten. Contract and retained TASK-058 history: [archive](DOTFILES_TASKS_2026-09-07_CONTEXT_RETENTION.md).
